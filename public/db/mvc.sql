...
--
-- Host: localhost
-- Generation Time: 2017-07-25 13:29:46
...
CREATE TABLE `sys_admin` (
  ...
  `position` varchar(12) DEFAULT NULL COMMENT '职称',
  `rtime` datetime DEFAULT NULL COMMENT '注册时间',
  `state` varchar(1) DEFAULT '1' COMMENT '状态(1正常,2禁用)',
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'klingsoul@163.com', '15088885555', '杨文春', '项目中心', '管理员', '2017-05-10 00:00:00', '1', '1:0 2:0 10:0 3:0 4:0 5:0 6:31 7:31 8:63');
...
CREATE TABLE `sys_menus` (
  `id` tinyint(3) NOT NULL COMMENT 'ID',
  `fid` varchar(3) NOT NULL COMMENT '父ID',
  `title` varchar(12) NOT NULL COMMENT '标题',
  `url` varchar(32) DEFAULT NULL COMMENT '地址',
  `perm` varchar(6) DEFAULT NULL COMMENT '预设权限',
...
(1, '0', '首页', 'Welcome', '0', 'ico-home', '2017-05-12 00:00:00', 0, NULL),
(2, '0', '系统', 'System', '0', 'ico-system', '2017-05-12 00:00:00', 0, NULL),
(3, '1', '桌面', '#', '0', 'ico-disktop', '2017-05-12 00:00:00', 0, ''),
(4, '2', '系统管理', '#', '0', 'ico-system1', '2017-05-12 00:00:00', 0, NULL),
...
--
ALTER TABLE `sys_menus_action`
  MODIFY `id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=10;COMMIT;
